...
namespace OnlineStore.Migrations
{
    ...
    [Migration("20260410155156_UpdateProductImages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineStore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrl = "https://placehold.co/300x300/0d6efd/ffffff?text=Galaxy+S24",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://placehold.co/300x300/212529/ffffff?text=ThinkPad+X1",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://placehold.co/300x300/6c757d/ffffff?text=T-Shirt",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://placehold.co/300x300/1e3a8a/ffffff?text=Jeans",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "https://placehold.co/300x300/198754/ffffff?text=C%23+Book",
                            Name = "C# in Depth",
                            Price = 2490m,
                            Stock = 30
                        });
            ...
            modelBuilder.Entity("OnlineStore.Models.ProductDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OnlineStore.Models.ProductDetails", b =>
                {
                    b.HasOne("OnlineStore.Models.Product", "Product")
                        .WithOne("Details")
                        .HasForeignKey("OnlineStore.Models.ProductDetails", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
